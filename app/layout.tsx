...
export const metadata: Metadata = {
  title: 'InvestKid - Learn Investing Through Fun',
  description: 'InvestKid: A fun and easy way for kids aged 12-18 to learn about investing through virtual stock market games and bite-sized lessons.',
  generator: 'v0.app',
  icons: {
    icon: [
      {
...
export default function RootLayout({
  ...
  var TOKEN="6fd92ff8-1442-459a-b5cc-1526907ea295151319531472be773b9b75db6fa54b28";
